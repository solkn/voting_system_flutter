...
import 'package:voting_system_flutter/widgets/candidate_component_user.dart';

class UserCandidateScreen extends StatelessWidget{
  final GlobalKey<ScaffoldState> scaffoldKey;
  UserCandidateScreen({@required this.scaffoldKey});
        ...
        builder: (context,state) {
          if (state is CandidateFetchingState) {
            ...
            return ListView.builder(
                ...
                itemBuilder: (_,idx)=>CandidateComponentUser(candidate: candidates[idx]));
